...
{
    /// <summary>
    /// Reference: https://github.com/andrewlock/NetEscapades.Configuration/blob/master/src/NetEscapades.Configuration.Yaml/YamlConfigurationFileParser.cs
    /// </summary>
    internal class YamlConfigurationFileParser
    {
        ...
        private void VisitYamlScalarNode(string context, YamlScalarNode yamlValue)
        {
            ...
            {
                throw new FormatException($"The key {currentKey} is duplicated!");
            }
